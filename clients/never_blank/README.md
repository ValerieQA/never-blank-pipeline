...
| `lenses/evidence_tension_lens.md` | **Conditional** (#263): what Never Blank does when a signal's own research evidence contradicts the source's claim — the Evidence Tension Lens |
