...
# #211 forced deviation: the July feed set travels WITH this package.
# Pointing at config/research_sources.yaml would hand Wednesday the
# current small-business feeds — the exact regression being undone.
SOURCES_CONFIG = Path(__file__).with_name("research_sources_july.yaml")
